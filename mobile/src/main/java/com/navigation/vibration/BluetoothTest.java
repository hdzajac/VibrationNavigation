...
public class BluetoothTest extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        adapter= new ArrayAdapter<String>(BluetoothTest.this, android.R.layout.simple_list_item_1, arrayListpaired);
        detectedAdapter = new ArrayAdapter<String>(BluetoothTest.this, android.R.layout.simple_list_item_single_choice);
    ...
    private void startSearching() {
        ...
        BluetoothTest.this.registerReceiver(myReceiver, intentFilter);
