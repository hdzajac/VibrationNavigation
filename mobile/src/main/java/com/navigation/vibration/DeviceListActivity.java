...
public class DeviceListActivity extends Activity {
    ...
    public static String DEVICE_POSITION = "POSITION";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        devicePosition=getIntent().getStringExtra(DEVICE_POSITION);
        Log.v(TAG,"Got from intet "+devicePosition);
    }
    ...
    private OnItemClickListener mDeviceClickListener = new OnItemClickListener() {
        public void onItemClick(AdapterView av, View v, int arg2, long arg3) {
            ...
            Log.v(TAG,"About to connect. Returning to connecting activity.");
            bluetoothAdapter.cancelDiscovery();
            ...
            intent.putExtra(DEVICE_POSITION,devicePosition);
            Log.v(TAG,"finishing activity with "+ intent.getStringExtra(DEVICE_POSITION));
